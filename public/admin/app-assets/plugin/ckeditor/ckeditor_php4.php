...
class CKEditor
{
	 ...
	 * @param $events (array) Product listeners for this editor instance (optional).
	 *
	 * Example usage:
	 * @code
	 * $CKEditor = new CKEditor();
	 ...
	 *
	 * @param $event (string) Product name.
	 ...
	 *
	 * @param $event (string) Product name, if not set all event handlers will be removed (optional).
	 */
	 ...
	 * @param $events (array) Product listeners for editor instance.
	 */
