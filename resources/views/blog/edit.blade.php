            ...
            <div class="content-body">
                <section class="modern-horizontal-wizard">
                    <div class="bs-stepper wizard-modern modern-wizard-example">
                        {!! Form::open(['method'=>'PUT','route'=>['blog.update', $blog->id], 'files' => true, 'class' => 'form-first jsFormValidate']) !!}
                            ...
                            <div class="bs-stepper-content">
                                            ...
                                            <div class="row input_image">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        {!! Form::hidden('edit_banner_image', $blog->banner_image, ['class' => 'edit_image']) !!}
                                                ...
                                                @if(!empty($blog->banner_image))
                                                    <div class="col-md-6 my-1" id="image-tag">
                                                        <img src="{{ asset('storage/'.$blog->banner_image) }}" alt="" style="height:100px; width:100px">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row input_image">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        {!! Form::hidden('edit_image', $blog->image, ['class' => 'edit_image']) !!}
                                                        <div class="input-group-append">
                                                ...
                                                @if(!empty($blog->image))
                                                    <div class="col-md-6 my-1" id="image-tag">
                                                        <img src="{{ asset('storage/'.$blog->image) }}" alt="" style="height:100px; width:100px">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                {!! Form::text('image_alt_tag', $blog->image_alt_tag, ['class'=>'form-control'])!!}
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="description">Description</label>
                                                {!! Form::textarea('description', $blog->description, ['class' => 'form-control ckeditor']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="last-name-column">Sort Order</label>
                                                {!! Form::text('sort_order', $blog->sort_order, ['class'=>'form-control only_numbers'])!!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="basicSelect">Status <span class="error">*</span></label>
                                                {{Form::select('status', status(), $blog->status, ['class' => 'form-select', 'placeholder'=>'Please Select'])}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                {!! Form::text('seo_url', $blog->seo_url, ['class'=>'form-control']) !!}
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                {!! Form::textarea('meta_description', $blog->meta_description, ['class'=>'form-control', 'rows' => 5])!!}
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="first-name-column">Schema Tag  </label>
                                                {!! Form::textarea('schema_tag', $blog->schema_tag, ['class'=>'form-control', 'rows' => 5])!!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-1">
                                    <div class="col-12">
                                        ...
                                        <a href="{{ route('blog.index') }}" class="btn btn-outline-secondary">Back</a>
                                    </div>
                                </div>
                            </div>
                        </form>
