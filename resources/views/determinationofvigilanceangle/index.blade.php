    ...
    @section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Determination of Vigilance Angle</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-md-end text-end col-xl-3 col-md-12 col-sm-12 col-12 d-md-block ">
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <a href="{{ route('determinationofvigilanceangle.create') }}" class="btn btn-outline-primary"><i class="fa fa-plus"></i>&nbsp;</i>Add</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive" id="DeterminationofVigilanceAngle">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#DeterminationofVigilanceAngle");
            var delete_url="{{ route('determinationofvigilanceangle.multiple_delete') }}";
            var status_url="{{ route('determinationofvigilanceangle.change_status') }}";
            ...
            $(function () {
                ...
                if (dt_filter_table.length) {
                    ...
                    var dt_filter = dt_filter_table.DataTable({
                        ajax: "{{ route('determinationofvigilanceangle.index') }}",
                        columns: [
