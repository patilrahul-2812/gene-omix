    ...
    @section('content')
                ...
                <div class="content-header-right text-md-end text-end col-xl-3 col-md-12 col-sm-12 col-12 d-md-block ">
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <a href="{{ route('state.create') }}" class="btn btn-outline-primary"><i class="fa fa-plus"></i>&nbsp;</i>Add</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive" id="State">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#State");
            var delete_url="{{ route('state.multiple_delete') }}";
            var status_url="{{ route('state.change_status') }}";
