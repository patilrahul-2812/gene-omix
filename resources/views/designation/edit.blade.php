                ...
                <section id="multiple-column-form">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    {!! Form::open(['method'=>'PUT','route'=>['designation.update',$designation->id], 'class'=>'form FormValidate', 'autocomplete' => 'off']) !!}
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    {!! Form::select('status', status(), $designation->status, ['class' => 'form-select', 'placeholder'=>'Please Select']) !!}
                                                </div>
                                            </div>
                                            <div class="col-12">
