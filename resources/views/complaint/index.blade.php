    ...
    @section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Complaint</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive" id="Complaint">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#Complaint");
            var delete_url="{{ route('complaint.multiple_delete') }}";
            var status_url="{{ route('complaint.change_status') }}";
                ...
                if (dt_filter_table.length) {
                    ...
                    var dt_filter = dt_filter_table.DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'complaint_no',orderable:true },
                            { data: 'full_name',orderable:true },
                            { data: 'email_id',orderable:true },
                            { data: 'mobile_no',orderable:false },
                            { data: 'complaint_date',orderable:false },
                            { data: 'complaint_status',orderable:false },
