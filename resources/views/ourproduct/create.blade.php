            ...
            <div class="content-body">
                <section class="modern-horizontal-wizard">
                    <div class="bs-stepper wizard-modern modern-wizard-example">
                        {!! Form::open(['method'=>'POST','route'=>['ourproduct.store'], 'files' => true, 'class' => 'form-first jsFormValidate']) !!}
                            ...
                            <div class="bs-stepper-content">
                                <div id="account-details-modern" class="content" role="tabpanel" aria-labelledby="account-details-modern-trigger">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-1">
                                                <label class="form-label" for="brand-list">Brand<span class="error">*</span></label>
                                                {!! Form::select('brand_id', $brandlist, null, ['class'=>'form-select', 'placeholder' => 'Select Brand']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-1">
