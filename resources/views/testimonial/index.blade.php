    ...
    @section('content')
                ...
                <div class="content-header-right text-md-end text-end col-xl-3 col-md-12 col-sm-12 col-12 d-md-block ">
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <a href="{{ route('testimonial.create') }}" class="btn btn-outline-primary"><i class="fa fa-plus"></i>&nbsp;</i>Add</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-datatable">
                                    <table class="dt-column-search table table-responsive" id="Testimonial">
                                        <thead>
                                            <tr>
        ...
        <script>
            var table_id = $("#Testimonial");
            var delete_url="{{ route('testimonial.multiple_delete') }}";
            var status_url="{{ route('testimonial.change_status') }}";
                ...
                if (dt_filter_table.length) {
                    ...
                    var dt_filter = dt_filter_table.DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'client_name',orderable:true },
