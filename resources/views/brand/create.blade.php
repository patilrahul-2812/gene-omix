            ...
            <div class="content-body">
                <section class="modern-horizontal-wizard">
                    <div class="bs-stepper wizard-modern modern-wizard-example">
                        {!! Form::open(['method'=>'POST','route'=>['brand.store'], 'files' => true, 'class' => 'form-first jsFormValidate']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                {!! Form::text('brand_logo_alt_tag', null, ['class'=>'form-control'])!!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 mb-2">
                                            <div class="row input_image">
                                                <div class="col-md-8">
                                                    <label for="image_label">Brochure <span class="error"> (Brochure Size must be 1MB or 2 MB)</span></label>
                                                    <div class="input-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                ...
                                                {!! Form::textarea('brand_description', null, ['class' => 'form-control ckeditor']) !!}
                                            </div>
                                        </div>
