    ...
    @section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Product Inquiry</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            var delete_url="{{ route('ourproductinquiry.multiple_delete') }}";
            ...
            $(function () {
                ...
                if (dt_filter_table.length) {
                    ...
                    var dt_filter = dt_filter_table.DataTable({
                        ajax: "{{ route('ourproductinquiry.index') }}",
                        columns: [
