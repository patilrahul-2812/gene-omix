                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    {!! Form::open(['method'=>'POST','route'=>['slider.store'], 'class'=>'form-first FormValidate', 'files'=>true, 'autocomplete' => 'off']) !!}
                                        <div class="row">
                                            <div class="col-xl-3 col-md-3 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="title1">Title1</label>
                                                    {!! Form::textarea('title1', null, ['class'=>'form-control', 'rows' => 3]) !!}
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-3 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="title1-color">Title1 Color</label>
                                                    {!! Form::color('title1_color', null, ['class'=>'form-control']) !!}
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-3 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="title2">Title2 </label>
                                                    {!! Form::textarea('title2', null, ['class'=>'form-control', 'rows' => 3]) !!}
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-md-3 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="title2-color">Title2 Color</label>
                                                    {!! Form::color('title2_color', null, ['class'=>'form-control']) !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12 mb-1 mb-sm-0">
                                                <div class="row input_image">
                                                    <div class="col-md-9">
                                                        <label for="image_label">Image <span class="error">* (Image Size must be 1920px * 800px)</span></label>
                                            ...
                                            <div class="col-xl-6 col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    {!! Form::text('alt_tag', null, ['class'=>'form-control'])!!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
